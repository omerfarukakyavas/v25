                          ...
                          @for (dava of filtrelenmisDavalar; track dava.id) {
                            <tr class="hover:bg-blue-50/40 transition-colors group">
                              ...
                              <td class="p-4 align-top text-right">
                                <div class="flex min-w-[108px] items-center justify-end gap-1.5">
                                  @if (silinecekDavaId === dava.id) {
                                    ...
                                    <button (click)="silmeIptal()" class="bg-slate-200 text-slate-700 hover:bg-slate-300 p-1.5 rounded transition-colors" title="İptal">İptal</button>
                                     ...
                                     <button (click)="detayaGit(dava)" class="rounded-lg p-1.5 text-indigo-500 transition-colors hover:bg-indigo-50" title="Detay"><svg class="h-4.5 w-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg></button>
                                     <button (click)="dosyaFormunuAc(dava)" class="rounded-lg p-1.5 text-amber-500 transition-colors hover:bg-amber-50" title="Düzenle"><svg class="h-4.5 w-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg></button>
                                     <button (click)="silmeOnayiIste(dava.id, 'dava')" class="rounded-lg p-1.5 text-red-500 transition-colors hover:bg-red-50" title="Sil"><svg class="h-4.5 w-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>
                                  }
                                </div>
                              </td>
                            </tr>
